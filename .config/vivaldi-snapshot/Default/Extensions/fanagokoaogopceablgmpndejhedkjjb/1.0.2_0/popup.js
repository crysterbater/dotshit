...
function renderList(){
    ...
    for(var i=items.length-1; i>=0; i--){
        ...
        title.click(function(){
            ...
            //_gaq.push(['_trackEvent','popup','play']);
        });
        video.append(title);
        ...
        del.click(function(){
            ...
            if(confirm('Really do you want to delete this item?')){
                ...
                //_gaq.push(['_trackEvent','popup','remove']);
            }
            reloadList();
        });
        video.append(del);
...
$(document).ready(function(){
    ...
    $('.tab').click(function(){
        ...
        //_gaq.push(['_trackEvent','popup','go detail']);
    });
    
    $('.add_actual').click(function(){
        bgPage.checkFlash('file','content_manual.js');
        setTimeout(function(){
            reloadList();
        },2000);
        //_gaq.push(['_trackEvent','popup','add actual']);
    });
    
    $('.add_url').click(function(){
        window.open('options.html','_blank');
        //_gaq.push(['_trackEvent','popup','open options']);
    });
...
_gaq.push(['_trackEvent','popup','start page']);
(function() {
